...
urlpatterns = [
    ...
    path('sign_info/', bg.sign_info, name='signed'),
    path('signed_info_detail/', bg.signed_info_detail, name='signed_info'),
    path('teacher/', bg.teacher, name='teacher'),
    path('super/', bg.super, name='super'),
    path('add_course/', bg.add_course, name='add_course'),
    path('del_course/', bg.del_course, name='del_course'),
